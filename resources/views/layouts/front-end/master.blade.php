					...
					<ul class="l-inline ov">
						...
						<li><a href="#">Loại sản phẩm</a>
							<ul class="sub-menu">
								...
								<li><a href="/loai-san-pham/4">Bánh kem</a></li>
								<li><a href="/loai-san-pham/5">Bánh crepe</a></li>
								<li><a href="/loai-san-pham/6">Bánh Pizza</a></li>
								<li><a href="/loai-san-pham/7">Bánh su kem</a></li>
							</ul>
						</li>
